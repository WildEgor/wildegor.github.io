...
export default class ClassicAlgorithms {

  public static searchUnique(s: string):string {
    const origString = s.split('');

    const map = origString.reduce((acc, cur, i) => {
  ...
  public static arrIntersection (firstArray: number[], secondArray: number[]): number[] {
    const newArray = [];
  ...
  public static fibonacciReq(n: number): number {
    if (n === 1 || n === 2) return 1;
  ...
  public static fibonacciClosedForm(position: number): number {
  ...
  public static swapTwo(numOne: number, numTwo: number): number[] {
    return [numTwo, numOne]
  }

  public static linearSearch(array: number[], item: number): number | null {
  ...
  public static insertionSort(array: number[]): number[] {
  ...
  public static dummySort(array: number[]): number[] {
  ...
  public static reqBinarySearch(arr: number[], value: number): number {
 ...
 public static binarySearch(array: number[], item: number): number {
    const newArray = [...array];
...
// ClassicAlgorithms.binarySearch()
